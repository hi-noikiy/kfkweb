		...
		<div class="tab-content">
			<div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
				<div class="page-quick-sidebar-list"
				     style="position: relative; overflow: hidden; width: auto; height: 592px;">
					<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
					     data-wrapper-class="page-quick-sidebar-list" data-height="592" data-initialized="1"
					     style="overflow: hidden; width: auto; height: 592px;">
					...
					<div class="slimScrollBar"
					     style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 392.897px;"></div>
				...
				<div class="page-quick-sidebar-item">
					<div class="page-quick-sidebar-chat-user">
						...
						<div class="slimScrollDiv"
						     style="position: relative; overflow: hidden; width: auto; height: 487px;">
							<div class="page-quick-sidebar-chat-user-messages" data-height="487"
							     data-initialized="1" style="overflow: hidden; width: auto; height: 487px;">
								<div class="post out">
							...
							<div class="slimScrollBar"
							     style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 350.842px;"></div>
							<div class="slimScrollRail"
			...
			<div class="tab-pane page-quick-sidebar-alerts" id="quick_sidebar_tab_2">
				<div class="slimScrollDiv"
				     style="position: relative; overflow: hidden; width: auto; height: 667px;">
					<div class="page-quick-sidebar-alerts-list" data-height="667" data-initialized="1"
					     style="overflow: hidden; width: auto; height: 667px;">
			...
			<div class="tab-pane page-quick-sidebar-settings" id="quick_sidebar_tab_3">
				<div class="slimScrollDiv"
				     style="position: relative; overflow: hidden; width: auto; height: 667px;">
					<div class="page-quick-sidebar-settings-list" data-height="667" data-initialized="1"
					     style="overflow: hidden; width: auto; height: 667px;">
