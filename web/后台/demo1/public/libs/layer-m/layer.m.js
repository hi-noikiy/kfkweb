...
;!function (a) {
	...
	j.prototype.view = function () {
		...
		if ( a.time && (ready.timer[c.index] = setTimeout(function () {
			...
			var d = b[e]("layermend")[0], f = function () {
		...
		if ( a.btn )for (var h = b[e]("layermbtn")[0].children, i = h.length, j = 0; i > j; j++)ready.touch(h[j], g), h[j].onclick = g;
