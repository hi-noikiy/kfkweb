...
visitRecord.init = function() {
    ...
    if (visitRecord.cookie.Get("uniID") != null) {
        e = visitRecord.cookie.Get("uniID")
    } else {
        e = 0
    }
...
//    $.getJSON("/ajax.php", {page: i, referrerPage: encodeURI(j), jssrc: l, userId: h, sessionId: d, visitorId: k, screen: n, viewCount: m, isFirst: c, universityID: e, firstTime: a, lastTime: b, viewTime: o}, function(p) {
//    })
};
...
visitRecord.defaults = {ajaxurl: "http://kaichiba.com/VR/WSRecord.asmx/"};
visitRecord.cookie = {Get: function(a) {
        var b = new RegExp("(?:;)?" + a + "=([^;]*);?");
