...
<head>
    ...
    <script type="text/javascript" src="http://misc.360buyimg.com/??jdf/lib/jquery-1.6.4.js,jdf/1.0.0/unit/base/1.0.0/base.js"></script>
    <link type="text/css" rel="stylesheet"  href="http://misc.360buyimg.com/product/error/1.0.0/css/error.reco.css" source="combo"/>
</head>

<body>
<script type="text/javascript" src="http://misc.360buyimg.com/lib/js/2012/base-2011.js" charset="utf-8"></script>
...
</div><!--shortcut end--><div id="o-header-2013">
...
<script>
    ...
    seajs.use('product/error/1.0.0/js/error.reco', function(errorReco) {
        errorReco();
    });
    seajs.use(['http://fa.360buy.com/loadFa_toJson.js?aid=2_697_5512', 'http://wl.jd.com/wl.js']);
</script>
