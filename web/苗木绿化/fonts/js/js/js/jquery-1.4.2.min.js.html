...
<style type="text/css">html{background:url("http://www.ui92.com/demo/html/2676/fonts/js/js/js/images/paper.jpg")!important;}
...
<script type="text/javascript" src="http://www.ui92.com/demo/html/2676/fonts/js/js/js/js/jquery-1.4.2.min.js"></script>
<!--解决 IE6 背景缓存-->
...
<body>
    ...
    <div id="wrapper">
        <a href="http://www.17sucai.com/"><img src="http://www.ui92.com/demo/html/2676/fonts/js/js/js/images/404_icon.png"></a>
        <div>
            <h1>唉呀!</h1>
