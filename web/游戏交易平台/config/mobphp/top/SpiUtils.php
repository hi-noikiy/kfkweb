...
class SpiUtils{
	...
	/**
	 * �ݡ验SPI请求�о名，适用于所���GET请求，�ǿ不包含文件参数的POST请求�?	 * 
	 * @param request 请求对象
	 * @param secret app对应�Єsecret
	 * @return true：校验�뵱�；false：校验不��뵱�
	 */
	...
	/**
	 * �ݡ验SPI请求�о名，适用于请汱���是xml/json�Љ可用文���表示的POST请求�?	 * 
	 * @param request 请求对象
	 * @param body 请求体的文本内容
	 * @param secret app对应�Єsecret
	 * @return true：校验�뵱�；false：校验不��뵱�
	...
	/**
	 * �ݡ验SPI请求�о名，适用于带文件�¦���п�OST请求�?	 * 
	 * @param request 请求对象
	 * @param form 除��文件参数以外�Є所���普�͚文���参数的map��合
	 * @param secret app对应�Єsecret
	 * @return true：校验�뵱�；false：校验不��뵱�
	 */
	...
	private static function getHeaderMap() {
		$headerMap = array();
		$signList = $_SERVER['HTTP_TOP_SIGN_LIST']; // 只获取参与签�᫚�头部字段
