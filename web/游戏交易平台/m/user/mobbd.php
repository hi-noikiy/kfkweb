...
<div class="boxcap box">
 <div class="d1"><a href="../">用户中心</a> - 手机绑定</div>
</div>
 ...
 <div id="uk3">
  ...
  <div class="uk box">
   ...
   <div class="d2"><input type="text" name="tyzm" id="tyzm" placeholder="请输入图形验证码" /></div>
   <div class="dyzm"><img src="../../config/getYZM.php" width="88" /></div>
  </div>

  <div class="tjbutton box">
   <div class="d0"></div>
   <div class="d1"><input type="button" onClick="delbd()" class="tjinput" value="解除手机绑定" /></div>
   <div class="d0"></div>
  </div>
 </div>
 ...
 <div id="uk1">
  <div class="uk box">
   ...
   <div class="d2"><input type="text" name="t1" id="t1" value="<?=$rowuser[mot]?>" placeholder="请输入手机号码" /></div>
  </div>
  <div class="uk box">
   <div class="d1"><img src="../img/suo.png" /></div>
   <div class="d2"><input type="text" name="tyzm" id="tyzm" placeholder="请输入图形验证码" /></div>
 ...
 <div id="uk2" style="display:none;">
  ...
  <div class="tjbutton box">
   <div class="d0"></div>
   <div class="d1"><input type="button" onClick="bd()" class="tjinput" value="绑定手机" /></div>
   <div class="d0"></div>
  </div>
 </div>
