...
$sfz1="../../upload/".$rowuser[id]."/".strgb2312($rowuser[sfz],0,15)."-2.jpg";
?>
<html>
<html>
<head>
...
一、填写真实姓名和身份证号码<br>
二、上传身份证正面照片<br>
<strong class="blue">三、上传身份证反面照片</strong><br>
四、上传手持身份证半身人像照片<br>
</div>
</div>

<div class="listcap box"><div class="d2">请上传身份证反面：</div></div>
...
<? if(is_file($sfz2)){?>
<div class="tishi box">
<div class="d1" style="text-align:center;"><a href="<?=$sfz2?>" target="_blank"><img border="0" src="<?=$sfz2?>" width="170" height="100" /></a></d1>
</div>
<? }?>
