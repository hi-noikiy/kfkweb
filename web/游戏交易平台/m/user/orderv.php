 ...
 <? if(!empty($row[liuyan])){?>
 <div class="orderm box"><div class="d1">购买留言</div><div class="d2"><?=$row[liuyan]?></div></div>
 <? }?>
 ...
 <? if($row[ddzt]=="backerr"){?>
 <div class="orderm box"><div class="d1">退款申请</div><div class="d2">您于 <?=$row[tksj]?> 申请了退款<br>退款理由：<?=$row[tkly]?></div></div>
 <div class="orderm box"><div class="d1">退款申请回复</div><div class="d2">卖家于 <?=$row[tkoksj]?> 拒绝了本次退款申请<br>原因：<?=$row[tkjg]?></div></div>
 
 <? }elseif($row[ddzt]=="backsuc"){?>
 <div class="orderm box"><div class="d1">退款申请</div><div class="d2">您于 <?=$row[tksj]?> 申请了退款<br>退款理由：<?=$row[tkly]?></div></div>
 <div class="orderm box"><div class="d1">退款申请回复</div><div class="d2">卖家于 <?=$row[tkoksj]?> 同意了本次退款申请<br>回复：<?=$row[tkjg]?></div></div>
 
 <? }?>
 
<div class="orderm box"><div class="d1">卖家LINE</div><div class="d2"> <?=returnqq($row[selluserid])?> </div></div>