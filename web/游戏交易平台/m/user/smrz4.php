...
$sfz1="../../upload/".$rowuser[id]."/".strgb2312($rowuser[sfz],0,15)."-3.jpg";
?>
<html>
<html>
<head>
...
二、上传身份证正面照片<br>
三、上传身份证反面照片<br>
<strong class="blue">四、上传手持身份证半身人像照片</strong><br>
</div>
</div>

<div class="listcap box"><div class="d2">请上传手持身份证清晰半身照：</div></div>
...
<div class="tishi box">
 <div class="d1">
  ...
  'onUploadComplete':function(file, data){
   location.href="../tishi/index.php?admin=999&b=../user/smrz.php";
   }
  });
  });
  </script>
...
<? if(is_file($sfz3)){?>
<div class="tishi box">
<div class="d1" style="text-align:center;"><a href="<?=$sfz3?>" target="_blank"><img border="0" src="<?=$sfz3?>" width="170" height="100" /></a></d1>
</div>
<? }?>
