...
if(sqlzhuru($_POST[jvs])=="pay"){
 ...
 if(empty($t1)){Audit_alert("请输入与扫码支付一致的金额","alipay_ewm_wap.php");}
 if(empty($t2)){Audit_alert("请输入扫码支付成功后的支付宝订单号","alipay_ewm_wap.php");}
 ...
 php_toheader("alipay_ewm_wap.php?t=suc"); 
}
...
<div class="pay box" style="border:none">
 ...
 <ul class="pay1">
  ...
  <li class="" style="text-align:center"> <img src="../../img/alipay_ewm.jpg"  width="300" height="300" /></li>
    <li class="" style="text-align:left; color:#F00; font-weight:bold">
  <? systs("恭喜您，操作成功，<strong>我们将尽快核实入账</strong>，请稍等!","wxpay_ewm.php")?></li>
  <li class="" style="text-align:left">请打开手机<span class="red">支付宝</span>，扫描以上二维码充值转账，如有疑问，请咨询客服QQ</li>
