...
$ifwap=$_GET[ifwap];
if("yes"==$ifwap){
	Header("Location: ../m/user/wxpay_ewm_wap.php?money1=".$money1); 
	}
$sj=date("Y-m-d H:i:s");
...
<div class="right">
 <ul class="wz">
 <li class="l0">请选择：</li>
 <li class="g_ac0_h g_bc0_h">扫码支付</li>
 </ul>
 ...
 <li class="l2"><input type="text" class="inp" name="t2" /> <span class="red">请输入扫码支付成功后的微信订单号</span></li>
 <li class="l3"></li>
