...
while0("*","yjcode_pro where bh='".$bh."' and userid=".$userid);if(!$row=mysql_fetch_array($res)){php_toheader("./");}
...
<div class="yjcode">
<ul class="dqwz">
<li class="l1">您的位置：<a href="../" class="acy">首页</a> > <a href="./" class="acy">会员中心</a> > 商品图片管理</li>
</ul>
<? $leftid=1;include("left.php");?>
<!--RB-->
<div class="right">

 <? systs("恭喜您，操作成功!","protp.php?bh=".$bh)?>
 <ul class="protpcap">
 <li class="l1">图片</li>
 <li class="l2">排序</li>
 <li class="l3">最后更新</li>
 ...
 <li class="l2">
 <a href="javascript:void(0)" onclick="NcheckDEL(8,'yjcode_tp')" class="a2">删除</a>
 </li>
 <li class="l3"></li>
 </ul>
 <? while1("*","yjcode_tp where bh='".$bh."' and userid=".$userid." order by xh asc");while($row1=mysql_fetch_array($res1)){$tp="../".str_replace(".","-2.",$row1[tp]);?>
 <ul class="protplist">
