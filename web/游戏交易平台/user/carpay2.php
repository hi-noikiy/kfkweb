...
<div class="right">
 ...
 <div class="carpay">
  ...
  <ul class="srxqing">
    	<li>
        	区&nbsp;&nbsp;&nbsp;服：<input type="text" name="yxfwq" required placeholder="请输入游戏所在的区服"><span>*</span>
        </li>
    	<li>
        	账&nbsp;&nbsp;&nbsp;号：<input type="text" name="yxzh" required placeholder="请输入游戏账号"><span>*</span>
        </li>
    	<li>
        	等&nbsp;&nbsp;&nbsp;级：<input type="text" name="yxdj" required placeholder="请输入游戏等级"><span>*</span>
        </li>
    	<li>
        	角色名：<input type="text" name="yxjsm" required placeholder="请输入角色名称"><span>*</span>
        </li>
    	<li>
        	QQ号：<input type="text" name="yxqq" required placeholder="请输入QQ号"><span>*</span>
        </li>
        <li>
        	金&nbsp;&nbsp;&nbsp;额：<span><?=sprintf("%.2f",$needmoney)?></span>
        </li>
        <li>
