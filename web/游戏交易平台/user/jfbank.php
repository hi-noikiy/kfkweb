...
<div class="yjcode">
<ul class="dqwz">
<li class="l1">您的位置：<a href="../" class="acy">首页</a> > <a href="./" class="acy">会员中心</a> > 积分银行</li>
</ul>
...
<div class="right">
 ...
 <ul class="uk">
 <li class="l3"></li>
 <li class="l4"><input type="submit" class="btn1" onmouseover="this.className='btn2';" onmouseout="this.className='btn1';" value="提交兑换" /></li>
 </ul>
 </form>
