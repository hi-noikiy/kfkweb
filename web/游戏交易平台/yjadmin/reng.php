...
if(confirm("确定执行该操作吗？")){tjwait();f1.action="reng.php?id=<?=$id?>&control=update";}else{return false;}
}
</script>
</head>
<body>
...
<div class="right" id="right">
 <ul class="wz">
 <li class="l1">当前位置：后台首页 - <strong>人工对账管理</strong> [<a href="renglist.php">返回列表</a>]</li><li class="l2"></li>
 </ul>
 <div class="rights">
 &nbsp;<strong>提示：</strong><br>
 ...
 <ul class="uk">
 <li class="l3"><? tjbtnr("下一步","renglist.php")?></li>
 </ul>
 </form>
 <!--E-->
