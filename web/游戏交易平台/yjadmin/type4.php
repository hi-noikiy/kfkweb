...
<div class="right" id="right">
 ...
 当前位置：<a href="./" class="a2">后台首页</a> - 商品分组 - <strong><?=$ty1name?></strong> - <strong><?=$ty2name?></strong> - <strong><?=$ty3name?></strong> [<a href="typelist45.php?ty1id=<?=$ty1id?>&ty2id=<?=$ty2id?>&ty3id=<?=$ty3id?>">返回</a>]
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" onfocus="inpf(this)" onblur="inpb(this)" value="<?=returnxh("yjcode_type"," and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and admin=4")?>" /> <span class="hui">序号越小，越靠前</span></li>
 ...
 <li class="l2"><input type="text" class="inp redony" readonly="readonly" name="t98" value="<?=$ty3name?>" /></li>
 <li class="l1">四级名称：</li>
 <li class="l2"><input type="text" value="<?=$row[type4]?>" class="inp" name="t1" onfocus="inpf(this)" onblur="inpb(this)" /></li>
 <li class="l1">排序：</li>
