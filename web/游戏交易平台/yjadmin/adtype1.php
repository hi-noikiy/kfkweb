...
<div class="right" id="right">
 ...
 <?
 $adbh=array("ADO01","ADO02","ADS01","ADTASK01","ADTASK02","ADSHOP01","ADUSER1");
 $adtit=array("登录框背景广告","注册页右侧广告","商家列表页左上广告","任务大厅右上广告","任务大厅公告右侧广告","店铺页面默认通栏","卡密充值页提示");
 $adsize=array("1920*460","329*?","200*?","280*?","375*164","1920*120","898*?");
 $admust=array("","","","","","pic","");
