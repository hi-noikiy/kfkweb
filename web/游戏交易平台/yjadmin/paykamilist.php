...
function ser(){
location.href="paykamilist.php?st1="+$("st1").value+"&st2="+$("st2").value+"&sd1="+$("sd1").value;
}
</script>
</head>
<body>
...
<div class="right" id="right">
 <ul class="wz">
 <li class="l1">当前位置：后台首页 - <strong>充值卡密管理</strong></li><li class="l2"></li>
 </ul>
 <!--B-->
 <div class="listkuan">
 <ul class="psel">
 ...
 <li class="l2" onclick="gourl('paykami.php?id=<?=$row[id]?>&action=update')">&nbsp;<?=$row[ka]." ".$row[mi]?></li>
