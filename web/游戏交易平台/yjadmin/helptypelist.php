...
<div class="right" id="right">
 <ul class="wz"><li class="l1">当前位置：<a href="./" class="a2">后台首页</a> - <strong>帮助中心分类设置</strong></li><li class="l2"></li></ul>
 
 <!--begin-->
 <div class="listkuan">
 <ul class="typecap">
 <li class="l1"><input name="C2" type="checkbox" onclick="xuan()" /></li>
 <li class="l2">&nbsp;帮助中心分类列表</li>
 <li class="l3">序号</li>
 <li class="l4">编辑时间</li>
 <li class="l5">操作&nbsp;</li>
 </ul>
 ...
 <li class="l5"><a href="helptype1.php?ty1id=<?=$row1[id]?>">添加二级分类</a> | <a href="<?=$nu?>">编辑</a>&nbsp;</li>
 </ul>
 <?
