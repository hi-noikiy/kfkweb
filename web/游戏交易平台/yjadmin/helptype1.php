...
<div class="right" id="right">
 <ul class="wz"><li class="l1">当前位置：<a href="./" class="a2">后台首页</a> - <strong class="red"><?=$row[name1]?></strong> - <strong>编辑二级帮助中心分类</strong> [<a href="helptypelist.php">返回</a>]</li><li class="l2"></li></ul>
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" onfocus="inpf(this)" onblur="inpb(this)" value="<?=returnxh("yjcode_helptype"," and admin=2 and name1='".$row[name1]."'")?>" /> <span class="hui">序号越小，越靠前</span></li>
 <li class="l3"><? tjbtnr("保存修改","helptypelist.php");?></li>
 </ul>
 </form>
