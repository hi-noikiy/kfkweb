...
<div class="right" id="right">
 <ul class="wz">
 <li class="l1">当前位置：后台首页 - 任务大厅 - 多人任务 - <strong>任务接手情况</strong></li><li class="l2"></li>
 </ul>
 ...
 <li class="l2" onclick="gourl('<?=$aurl?>')">&nbsp;<?=strgb2312(strip_tags($row1[tit]),0,78)?> [<?=returntask1($row[zt])?>]</li>
