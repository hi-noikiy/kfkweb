...
<div class="right" id="right">
 <ul class="wz">
 <li class="l1">当前位置：后台首页 - 任务大厅 - <strong>单人任务</strong> [<a href="tasklist.php">返回</a>]</li><li class="l2"></li>
 </ul>
 ...
 <li class="l8"><? tjbtnr("下一步","tasklist.php")?><input type="hidden" value="zt8" name="jvs" /></li>
 <? }?>
 ...
 <li class="l8"><? tjbtnr("下一步","tasklist.php")?><input type="hidden" value="zt1" name="jvs" /></li>
 <? }?>
