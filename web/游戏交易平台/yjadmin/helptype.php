...
<div class="right" id="right">
 <ul class="wz"><li class="l1">当前位置：<a href="./" class="a2">后台首页</a> - <strong>帮助中心分类管理</strong> [<a href="helptypelist.php">返回</a>]</li><li class="l2"></li></ul>
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" onfocus="inpf(this)" onblur="inpb(this)" value="<?=returnxh("yjcode_helptype"," and admin=1")?>" /> <span class="hui">序号越小，越靠前</span></li>
