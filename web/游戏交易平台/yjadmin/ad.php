...
if($_GET[control]=="update"){  //表示修改
 ...
 zwzr();
 if(sqlzhuru($_POST[R1])=="图片"){$tp=inp_tp_upload(1,"../gg/",$_GET[bh]);}elseif(sqlzhuru($_POST[R1])=="动画"){$tp=inp_tp_upload(2,"../gg/",$_GET[bh]);}
...
<li class="l3"><? tjbtnr("保存广告","adlist.php?bh=".$row[adbh]."&sm=".urlencode($_GET[sm])."&must=".$_GET[must]);?></li>
</ul>
