...
function ser(){
location.href="newslist.php?st1="+$("st1").value+"&zt="+$("zt").value;	
}
</script>
</head>
<body>
...
<div class="right" id="right">
 <ul class="wz">
 <li class="l1">当前位置：后台首页 - <strong>资讯管理</strong></li><li class="l2"></li>
 </ul>
 ...
 <ul class="typecon">
 <li class="l1">
 <a href="javascript:checkDEL(6,'yjcode_news')" class="a1">变更审核</a>
 <a href="javascript:checkDEL(7,'yjcode_news')" class="a2">删除</a>
 ...
 <li class="l2" onclick="gourl('<?=$aurl?>')">&nbsp;<?=returntitcss(returntitdian($row["tit"],78),$row[ifjc],$row[titys])?><? if(1==$row[iftp]){?> <span class="red">[图]</span><? }?></li>
 <li class="l15"><?=returnztv($row[zt])?></li>
 <li class="l3"><?=$row[djl]?></li>
 <li class="l4"><?=$row[lastsj]?></li>
 <li class="l7">
 <a href="<?=$aurl?>">修改</a> | <a href="../news/txtlist_i<?=$row[id]?>v.html" target="_blank">预览</a>
 </li>
 </ul>
 <? }?>
 <?
