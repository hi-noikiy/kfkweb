...
<div class="right" id="right">
 <ul class="wz"><li class="l1">当前位置：<a href="./" class="a2">后台首页</a> - 商品分组 - <strong><?=$ty1name?></strong>  [<a href="typelist.php">返回</a>]</li><li class="l2"></li></ul>
 ...
 <li class="l5"><a href="type3.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>">添加三级类别</a> | <a href="<?=$nu?>">编辑</a>&nbsp;</li>
 </ul>
 <?
 ...
 <li class="l2" onclick="gourl('typelist45.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>&ty3id=<?=$row2[id]?>')">&nbsp;&nbsp;- <?=$row2[type3]?></li>
 <li class="l3"><?=$row2[xh]?></li>
 <li class="l4"><?=$row2[sj]?></li>
 <li class="l5"><a href="type4.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>&ty3id=<?=$row2[id]?>">添加四级类别</a> | <a href="<?=$nu?>">编辑</a>&nbsp;</li>
 </ul>
 <?
 }
 }
