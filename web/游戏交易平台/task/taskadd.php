...
if($_GET[control]=="add"){
 zwzr();
 if(empty($rowuser[uqq])){Audit_alert("请先补储您的联系QQ！","taskadd.php");}
 $sj=date("Y-m-d H:i:s");
...
if(x==-1){document.getElementById("zqtext").style.display="";zqcha();}
 ...
 if(x!=0){document.getElementById("zqs1").innerHTML=x+"天";}else{document.getElementById("zqs1").innerHTML="自己报的";}
}
}
function zqcha(){
...
<div class="yjcode">
 ...
 <div class="tleft fontyh">
  ...
  <div class="errts">请先补储您的QQ号码，才能发起任务。【<a href="../user/inf.php" target="_blank">点击补储</a>】</div>
  <? }?>
  ...
  <label><input name="R2" type="radio" value="0" onClick="zqonc(0)"> 服务商报时</label>
