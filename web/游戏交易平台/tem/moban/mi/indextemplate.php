...
<div class="yjcode">
 ...
 <ul class="u1 u1<?=$i?>">
 <li class="l1"><a href="<?=$au?>" target="_blank"><img class="tp" border="0" src="<?=returntppd(returntp("bh='".$row1[bh]."'","-1"),"img/none200x200.gif")?>" width="198" height="198" /></a><span class="djs" id="djs<?=$i?>">正在加载</span></li>
