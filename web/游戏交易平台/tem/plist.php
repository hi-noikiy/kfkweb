  ...
  <li class="l1">
  <a href="<?=$au?>" target="_blank"><img id="listbimg<?=$i?>" border="0" src="<?=returntppd(returntp("bh='".$row[bh]."'","-2"),"img/none200x200.gif")?>" width="210" height="210" class="bimtp" alt="<?=$row[tit]?>" /></a>
  </li>
